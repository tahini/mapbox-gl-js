...
* @returns true if a needed image is missing and rendering needs to be skipped.
    ...
    useProgram(name: string, programConfiguration: ?ProgramConfiguration, shaderName: ?string, fixedDefines: ?DynamicDefinesType[]): Program<any> {
        ...
        const key = Program.cacheKey(`${name}${shaderName ? shaderName : ''}`, allDefines, programConfiguration);
